...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ url('/public') }}/assets/img/logo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <!-- Main Sidebar Container sidebar.blade.php-->
  ...
  <!-- Content Wrapper. Contains page content sidebar.blade.php end -->
...
<!-- ChartJS -->
<script src="{{ url('/') }}/public/design/admin/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="{{ url('/') }}/public/design/admin/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
...
<script src="{{ url('/') }}/public/design/admin/plugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
...
<script src="{{ url('/') }}/public/design/admin/js/pages/dashboard.js"></script>
</body>
</html>
