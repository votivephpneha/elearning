                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-select form-control" id="course-dropdown" name="course_id">
                      <option value="">Select Courseeeeee</option>
                      <?php if($id>0){
                     
                       foreach($course_list as $course){?>
                      <option value="{{ $course->course_id }}" @if($course->course_id == $theory_detail[0]->course_id) selected @endif>
                        {{ $course->title }}
                      </option>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php if($id>0){
                      ...
                      <option value="{{ $topic->topic_id }}" @if($topic->topic_id == $theory_detail[0]->topic_id) selected @endif>
                        {{ $topic->title }}
                      </option>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-select form-control" id="chapter-dropdown" name="st_id">
                      ...
                      <option value="{{ $chapter->st_id }}" @if($chapter->st_id == $theory_detail[0]->st_id) selected @endif>
                        {{ $chapter->title }}
                      </option>
